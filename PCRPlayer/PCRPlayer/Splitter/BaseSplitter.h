...
public:
	...
	void Forearch(REFERENCE_TIME time);
	bool GetHeadTime(REFERENCE_TIME& time);
	bool GetTailTime(REFERENCE_TIME& time);
	bool GetTotalTime(REFERENCE_TIME& time);
};
...
public:
	...
	void QueueForeach(REFERENCE_TIME time);
	void QueueRemoveAll();
	bool QueueHeadTime(REFERENCE_TIME& time);
	bool QueueTailTime(REFERENCE_TIME& time);
	bool QueueTotalTime(REFERENCE_TIME& time);
