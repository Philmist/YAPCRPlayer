...
class CDisplayChannelDlg : public CDialog
{
	DECLARE_DYNAMIC(CDisplayChannelDlg)

public:
	CDisplayChannelDlg(CWnd* pParent = NULL);   // 標準コンストラクター
	virtual ~CDisplayChannelDlg();
...
// ダイアログ データ
	enum { IDD = IDD_DISPLAY_CHANNEL };

	sl::ChannelConfig channel_;
	std::vector<sl::ChannelPair> custom_;
