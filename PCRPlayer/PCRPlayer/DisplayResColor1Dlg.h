...
class CDisplayResColor1Dlg : public CDialog
{
	DECLARE_DYNAMIC(CDisplayResColor1Dlg)

public:
	//CDisplayResColor1Dlg(CWnd* pParent = NULL);   // 標準コンストラクター
	CDisplayResColor1Dlg(sl::ResConfig& res, CResSampleView& sample);
	virtual ~CDisplayResColor1Dlg();
...
// ダイアログ データ
	enum { IDD = IDD_DISPLAY_RES_COLOR1 };
