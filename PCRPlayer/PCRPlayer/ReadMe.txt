================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PCRPlayer プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PCRPlayer には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PCRPlayer アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
PCRPlayer.h
   ...
   CMainApp アプリケーション クラスを宣言します。

PCRPlayer.cpp
   これは、アプリケーション クラス CMainApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PCRPlayer.ico
   ...
   アイコンはメイン リソース ファイル PCRPlayer.rc に含まれていま
   す。
...
PCRPlayerDlg.h, PCRPlayerDlg.cpp - ダイアログ
   これらのファイルは CMainDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な PCRPlayer.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   PCRPlayer.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
