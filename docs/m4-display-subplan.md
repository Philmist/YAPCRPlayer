...
- [x] M4.0  MpvBackend プロパティ/オプション拡張 + 映像サイズ通知 + 窓サイズ純計算
- [x] M4.1  フィット/アスペクトモード（mpv オプション対応付け）
- [x] M4.2  ズーム% / 絶対サイズ / バー除外正確ピクセル プリセット
- [x] M4.3  全画面（ウィンドウごと）← 2026-06-10 完了
- [x] M4.4  スナップショット（mpv screenshot）← 2026-06-10 完了
- [ ] M4.5  （任意）結合 + 手動 E2E
